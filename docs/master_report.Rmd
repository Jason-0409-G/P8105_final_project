...
# Read raw data
raw_data <- read_csv("P8105_final_project/datasets/ca_dental.csv")
...
# Load the data
nhanes <- read_csv("P8105_final_project/datasets/nhanes_oral.csv")
...
```{r plot_statewide_trends, echo=FALSE, message=FALSE, warning=FALSE,fig.width=10, fig.height=6}
...
```{r plot_age_group_trends, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=6}
age_year_summary <- df %>%
...
```{r its_model_fit, echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(broom)
library(knitr)
...
```{r nhanes_slope_estimation, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r sex_diff_combined, echo = FALSE, message = FALSE, warning = FALSE,fig.width = 12, fig.height = 5}
...
```{r race, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=6}
# Choose outcome & age
...
```{r overlay_ca_nhanes, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=6}
...
```{r lifestage_heatmaps,echo=FALSE, message=FALSE, warning=FALSE, fig.width=12, fig.height=6}
library(dplyr)
library(stringr)
library(ggplot2)
library(readr)
...
```{r covid_impact_comparison, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=6}
library(tidyverse)
library(scales)
library(broom)
library(knitr)
