...
<p style="margin-top: 0; font-size: 1.6em; font-weight: 600; color: white;">Data Codebook</p>
...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; border-radius: 10px; margin-bottom: 30px;">
<p style="margin-top: 0; font-size: 1.6em; font-weight: 600; color: white;">Data Cleaning Process</p>
...
```{r ca-variable-mapping, echo=FALSE}
